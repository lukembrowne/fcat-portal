...
import { Home, TreePine, Leaf, Camera, Shield, DollarSign, BarChart3, CloudSun, ClipboardList, Thermometer, AudioLines, ScrollText, FileText, ChevronRight, PanelLeftClose, PanelLeftOpen } from "lucide-react";
