  ...
  try {
    ...
    const dbWithFolders = await db
      .select({
        ...
        uploadCalibrationCount: deployments.uploadCalibrationCount,
        ...
        uploadCalibrationFolderId: deployments.uploadCalibrationFolderId,
    ...
    const filtered = schedule
      ...
      .map((r) => {
        ...
        return {
          ...
          uploadCalibrationCount: dbRow.uploadCalibrationCount,
          ...
          uploadCalibrationFolderId: dbRow.uploadCalibrationFolderId,
...
export async function refreshSingleUploadCount(
  ...
  await db
    ...
    .set({
      ...
      uploadCalibrationSizeBytes: uploads.calibracionDeAudioSizeBytes ?? null,
      ...
      uploadNewestCalibrationDate: uploads.calibracionDeAudioNewestDate ?? null,
